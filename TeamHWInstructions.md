...
<!-- The first step is to create html file and we make the format for the outline - similar to what we did with the readme fiile with quesitons but connected with the html document -->
...
THEN I am prompted to enter the team manager’s name, (DONE) employee ID(DONE), email address(DONE), and office number(DONE)
...
THEN I am prompted to enter the engineer’s name, ID, email, and GitHub username, and (DONE) 
I am taken back to the menu DONE

WHEN I select the intern option
THEN I am prompted to enter the intern’s name, ID, email, and school, (DONE) and 
I am taken back to the menu DONE
